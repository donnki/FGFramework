...
function TestSteering:init(config)
    ...
    self.vehicle:addComponent("game.models.steering.SteeringForWander"):exportMethods()
    self.vehicle:addComponent("game.models.steering.AILocomotion"):exportMethods()
    self.vehicle:setPosition(display.cx, display.cy)
